---
title: "Capítulo 3 — Datos externos (leer y guardar archivos con pandas)"
---

[🚀 Abrir este capítulo en Google Colab](https://colab.research.google.com/github/FraRafa/manual/blob/main/notebooks/03-datos-externos.ipynb){.btn .btn-success target="_blank"}
...
- **ruta (path)**: ubicación del archivo (ej. `Datos/mi_archivo.csv`).
- **relativa**: ruta desde tu carpeta del proyecto.
- **absoluta**: ruta completa del disco (más frágil).
</details>
:::
