---
title: "Capítulo 7 — Intervalos de confianza e inferencia (t-test)"
---

[🚀 Abrir este capítulo en Google Colab](https://colab.research.google.com/github/FraRafa/manual/blob/main/notebooks/07-intervalos-de-confianza-e-inferencia.ipynb){.btn .btn-success target="_blank"}
...
- **valor p**: probabilidad (bajo H0) de ver un estadístico igual o más extremo.
...
> La parte “estadística” la asumes conocida. Aquí nos enfocamos en el **código** que implementa el procedimiento.
...
::: {.callout-note}
### Sintaxis clave (lo mínimo que debes dominar)
...
::: {.callout-tip}
### Tip rápido
Si `TD87` y `TD88` no tienen el mismo tamaño, la resta falla.  
...
::: {.callout-note}
### Por qué esto funciona (en código)
- `stats.t.cdf(t, df)` te da `P(T ≤ t)`.
- En cola izquierda, “más extremo” significa “más pequeño”.
:::

::: {.callout-warning}
### Error común #3: usar dos colas por accidente
Si tu hipótesis es **μ < 0**, el valor p es de **una cola**.  
...
Para H1: μ < 0, esperas `t` **negativo**.
:::
